...
<?php
    ...
    $html_output .= '<p id="update">Last update: ' . $jsonarray["metadata"]["creation_date"] . "</p>\n";
    ...
    foreach ($products as $i=>$product) {
        ...
        $html_output .= "</tbody>
                        ...
                        ";
        $html_output .= "<p><strong>Amazon:</strong> {$amazon_total} ({$amazon_enUS} en-US)\n";
        $html_output .= "<p>List of locales not using en-US: " . implode(', ', $locales_list['amazon']) . "</p>";
        $html_output .= "<p>Available variants (based on file name):</p><ol><li>" . implode('</li><li>', $variants) . "</li></ol>";
